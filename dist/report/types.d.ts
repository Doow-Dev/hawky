 ...
 */
export declare function gateResultToSummary(result: GateResult, displayName: string, blocking: boolean): GateSummary;
/**
 * Gate display names for reports
 */
export declare const GATE_DISPLAY_NAMES: Record<GateName, string>;
